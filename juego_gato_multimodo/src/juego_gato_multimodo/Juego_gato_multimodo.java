 ...
 * fecha:06/03/2014
 */
public class Juego_gato_multimodo extends JFrame implements ActionListener{
	...
	private JLabel texO;
	private JLabel texE;
	private JButton intermedio, dificil,ran;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Juego_gato_multimodo frame = new Juego_gato_multimodo();
	...
	public Juego_gato_multimodo() {
		...
		intermedio.setBounds(220, 140, 200, 20);
		intermedio.addActionListener(this);
		ventana.add(intermedio);
                
                dificil = new JButton("nivel experto");
		dificil.setBounds(220, 190, 200, 20);
		dificil.addActionListener(this);
		ventana.add(dificil);
                
                ran = new JButton("tira primero maquina");
		ran.setBounds(220, 240, 200, 20);
	...
	private void ComputerMove(int player, Color pcolor,int move) {
		int cont=0;
                if (move==0) 
			move = algo.Gameover(arre) == 0 ? algo.movimiento(player,arre,nivel) : 9;
		...
		case 8:
			...
			break;
                case 10:
                        ...
                        if(cont !=0)
                            ComputerMove(player,pcolor,move);
                    break;
		}
